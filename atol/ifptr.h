...
//! Драйвер контрольно-кассовых машин (дККМ)
namespace Fptr
{
...
enum Model
{
    ...
    ModelFPrint25K = 57,        /*!< АТОЛ FPrint-25                           */
    ModelFPrint30NEW = 61,      /*!< АТОЛ FPrint-30ПТК / ЕНВД                 */
    ModelFPrint55NEW = 62,      /*!< АТОЛ FPrint-55ПТК / ЕНВД                 */
    ModelFPrint22NEW = 63,      /*!< АТОЛ FPrint-22ПТК / ЕНВД                 */
    ModelFPrint5200NEW = 64,    /*!< АТОЛ FPrint-5200ПТК / ЕНВД               */
    ModelFPrint03NEW = 65,      /*!< АТОЛ FPrint-03ПТК / ЕНВД                 */
    ModelFPrint11NEW = 67,      /*!< АТОЛ FPrint-11ПТК / ЕНВД                 */
    ModelFPrint02NEW = 68,      /*!< АТОЛ FPrint-02ПТК / ЕНВД                 */
    ModelFPrint77NEW = 69,      /*!< АТОЛ FPrint-77ПТК / ЕНВД                 */
...
{
    BarcodeQRCorrectionDefault = 0, /*!< По умолчанию/выбору ККМ              */
...
enum ReportType
{
    ...
    ReportRom = 19,                 /*!< ПО ККМ                               */
    ReportRomUnit = 20,             /*!< ПО модуля ККМ                        */
    ...
    ReportPrintInfo = 43,           /*!< Печать информации о ККМ              */
    ReportTestDevice = 44,          /*!< Тестирование ККМ                     */
...
enum UnitType
{
    UnitMain = 1,               /*!< Процессор с внутренним ПО ККМ            */
...
//! Состояние изображения в памяти ККМ
enum PictureState
{
...
enum Font
{
    FontBySettings = 0,         /*!< По настройке ККМ                         */
    Font12x24,                  /*!< 12x24                                    */
    Font12x20,                  /*!< 12x20                                    */
    Font12x16,                  /*!< 12x16                                    */
    Font12x10,                  /*!< 12x10                                    */
...
enum FontHeight
{
    FontHeightBySettings = 0,   /*!< По настройке ККМ                         */
...
//! Создает экземпляр драйвера ККМ.
/*!
   ...
   \return Указатель на экземпляр драйвера ККМ
   \retval 0 Ошибка
 */
extern "C" DTOSHARED_EXPORT TED::Fptr::IFptr * DTOSHARED_CCA CreateFptrInterface(int ver);

//! Разрушает экземпляр драйвера ККМ.
/*!
   \param iface Экземпляр драйвера ККМ
 */
...
//! Интерфейс драйвера контрольно кассовых машин (дККМ)
...
public:
    ...
    //! Записывает строковый системный параметр в ККМ.
    /*!
       ...
       \warning Разные модели ККМ поддерживают разные параметры!
       \retval -1 Ошибка
       \retval 0 Успех
       \sa GetCaption()
     */
    ...
    //! Считывает строковый системный параметр из ККМ.
    /*!
       Считывает из ККМ строковый системный параметр под номером \a CaptionPurpose и записывает значение в \a Caption.
       <table>
        <caption>Свойства</caption>
        <tr><th>Название<th>Описание<th>Доступ
        <tr><th colspan=3>Входные свойства
    ...
    /*!
       Проверяет наличие строкового системного параметра под номером \a CaptionPurpose для настроенной модели ККМ.
       \param value Флаг наличия параметра
       \retval 0 Успех
       \sa put_CaptionPurpose()
     */
    ...
    //! Записывает числовой системный параметр в ККМ.
    /*!
    ...
    //! Считывает числовой системный параметр из ККМ.
    /*!
       Считывает из ККМ числовой системный параметр под номером \a ValuePurpose и записывает значение в \a Value.
       <table>
        <caption>Свойства</caption>
        <tr><th>Название<th>Описание<th>Доступ
        <tr><th colspan=3>Входные свойства
    ...
    /*!
       Проверяет наличие числового системного параметра под номером \a ValuePurpose для настроенной модели ККМ.
       \param value Флаг наличия параметра
       \retval 0 Успех
       \sa put_ValuePurpose()
     */
    ...
    //! Выдает звуковой сигнал средствами ККМ.
    /*!
       Выдает звуковой сигнал частотой \a Frequency (в гц) и длительностью \a Duration (в мс) средствами ККМ.
       <table>
        <caption>Свойства</caption>
        <tr><th>Название<th>Описание<th>Доступ
        <tr><th colspan=3>Входные свойства
    ...
    //! Открывает подключенный к ККМ денежный ящик.
    /*!
       \retval -1 Ошибка
       \retval 0 Успех
    ...
    /*!
       Метод подает команду ККМ открыть денежный ящик, подключенный к ККМ, используя заданные
    ...
    //! Заполняет свойства драйвера текущим состоянием ККМ.
    /*!
       <table>
        <caption>Свойства</caption>
        <tr><th>Название<th>Описание<th>Доступ
        ...
        <tr><td>LogicalNumber           <td>Номер ККМ                               <td>get_SessionOpened()
    ...
    //! Возвращает признак фискализированности ККМ.
    /*!
       \param value Признак фискализированности ККМ
       \retval 0 Успех
     */
    virtual int DTOSHARED_CCA get_Fiscal(int *value) = 0;

    //! Устанавливает время в ККМ.
    /*!
       Устанавливает время \a Time в ККМ.
       <table>
        <caption>Свойства</caption>
        <tr><th>Название<th>Описание<th>Доступ
        <tr><th colspan=3>Входные свойства
    ...
    /*!
       ...
       ККМ самостоятельно печатает клише на всех документах, предусмотренных технической
       документацией на нее. Но при печати каких-либо дополнительных документов можно
       оформить их «в едином стиле данной ККМ», напечатав в начале документа клише, а в конце
    ...
    /*!
       ...
       данной ККМ», напечатав в начале документа клише (методом PrintHeader()), а в конце
    ...
    /*!
       \param value Флаг печати данных штрихкода
       \retval 0 Успех
    ...
    /*!
       <table>
        ...
        <tr><th>Название<th>Описание<th>Доступ
        <tr><th colspan=3>Входные свойства
        <tr><td>Summ            <td>Тип чека (TED::Fptr::ChequeType)    <td>put_CheckType()
    ...
    /*!
       ...
       <table>
        ...
        <tr><td>SessionOpened       <td>Флаг открытости смены               <td>get_SessionOpened()
        <tr><td>Mode                <td>Режим (TED::Fptr::Mode)             <td>get_Mode()
        <tr><td>AdvancedMode        <td>Подрежим                            <td>get_AdvancedMode()
       ...
       <table>
        ...
        <tr><th rowspan=2>Номер<th colspan=10>Дополнительный параметр<th rowspan=2>Свойства
        <tr>        <th>CheckType<th>TypeClose<th>OperationType<th>CounterDimension<th>TaxNumber<th>DiscountNumber<th>CounterType<th>StepCounterType<th>PowerSupplyType<th>Department
        <tr><td>1   <td>+<td><td><td><td><td><td><td><td><td><td>Сумма всех регистраций (\a Summ)
        <tr><td>2   <td>+<td><td><td><td><td><td><td><td><td><td>Сумма всех сторно (\a Summ)
        <tr><td>3   <td>+<td>+<td><td><td><td><td><td><td><td><td>Сумма всех платежей (\a Summ)
        <tr><td>4   <td><td><td><td><td><td><td><td><td><td><td>Сумма внесений наличных денег (\a Summ)
        <tr><td>5   <td><td><td><td><td><td><td><td><td><td><td>Сумма выплат наличных денег (\a Summ)
        <tr><td>6   <td>+<td><td><td><td><td><td><td><td><td><td>Количество всех регистраций (\a Count)
        <tr><td>7   <td>+<td><td><td><td><td><td><td><td><td><td>Количество всех сторно (\a Count)
        <tr><td>8   <td><td><td><td><td><td><td><td><td><td><td>Количество всех внесений наличных денег (\a Count)
        <tr><td>9   <td><td><td><td><td><td><td><td><td><td><td>Количество всех выплат наличных денег (\a Count)
        <tr><td>10  <td><td><td><td><td><td><td><td><td><td><td>Сумма наличности в ККМ (\a Summ)
        <tr><td>11  <td><td><td><td><td><td><td><td><td><td><td>Выручка (\a Summ)
        <tr><td>12  <td><td><td>+<td><td><td><td><td><td><td><td>Сумма сменного итога (\a Summ)
        <tr><td>13  <td><td><td>+<td>+<td><td><td><td><td><td><td>Необнуляемая сумма по всем записям фискальной памяти + сменный итог текущей смены (\a Summ)
        <tr><td>14  <td><td><td>+<td>+<td><td><td><td><td><td><td>Необнуляемая сумма после последней перерегистрации + сменный итог текущей смены (\a Summ)
        <tr><td>15  <td><td><td><td><td><td><td><td><td><td><td>Количество оставшихся перерегистраций (\a Count)
        <tr><td>16  <td><td><td><td><td><td><td><td><td><td><td>Количество оставшихся сменных записей в фискальной памяти ККМ (\a Count)
        <tr><td>17  <td><td><td><td><td><td><td><td><td><td><td>Текущие дата и время в ККМ (\a Date, \a Time)
        <tr><td>18  <td><td><td><td><td><td><td><td><td><td><td>Флаг открытости смены (\a SessionOpened)
        <br>Дата и время окончания текущей смены (\a Date, \a Time)
        <tr><td>19  <td><td><td><td><td><td><td><td><td><td><td>Режим работы ККМ (\a Mode)
        <br>Номер текущего чека (\a CheckNumber)
        <br>Состояние текущего чека (\a CheckState)
        <br>Сквозной номер документа (\a DocNumber)
        <tr><td>20  <td><td><td><td><td><td><td><td><td><td><td>Текущая сумма чека (\a Summ)
        <br>Остаток чека (\a Remainder)
        <br>Сумма сдачи (\a Change)
        <tr><td>21  <td><td><td><td><td><td><td><td><td><td><td>Номер смены (\a Session)
        <tr><td>22  <td><td><td><td><td><td><td><td><td><td><td>Заводской номер ККМ (\a SerialNumber)
        <tr><td>23  <td><td><td><td><td><td><td><td><td><td><td>Модель ККМ (\a Model)
        <br>Версия и подверсия ККМ (\a VerHi, \a VerLo)
        <tr><td>24  <td><td><td><td><td><td><td><td><td><td><td>Параметры печатающего устройства (\a RcpCharLineLength, \a RcpPixelLineLength, \a JrnCharLineLength, \a JrnPixelLineLength, \a SlipCharLineLength, \a SlipPixelLineLength)
        <tr><td>25  <td><td><td><td><td><td><td><td><td><td><td>Длина входного буфера ККМ (\a Count)
        <tr><td>26  <td><td><td><td><td><td><td><td><td><td><td>Количество оставшихся активизаций ЭКЛЗ (\a Count)
        <tr><td>27  <td><td><td><td><td><td><td><td><td><td><td>Параметры фискализации:
        - ИНН (\a INN);
        - РНМ (\a MachineNumber);
        - Номер смены (\a Session);
        - Дата (\a Date)
        <tr><td>28  <td><td><td><td><td><td><td><td><td><td><td>Параметры ЭКЛЗ:
        - номер ЭКЛЗ (\a SerialNumber);
        - номер смены активизации (\a Session);
        - Дата активизации(\a Date)
        <tr><td>29  <td><td><td><td><td><td><td><td><td><td><td>Фискальная станция (\a PrintPurpose)
        <tr><td>30  <td><td><td>+<td><td><td><td><td><td><td><td>Сумма последней записи в ФП (\a Summ)
        <tr><td>31  <td>+<td><td><td><td>+<td><td><td><td><td><td>Счетчик зарегистрированных налогов (\a Summ)
        <tr><td>32  <td><td><td><td><td><td>+<td><td><td><td><td>Суммовой счётчик зарегистрированных скидок/надбавок за смену (\a Summ)
        <tr><td>33  <td><td><td><td><td><td><td>+<td><td><td><td>Количество отрезов (\a Count)
        <tr><td>34  <td><td><td><td><td><td><td>+<td>+<td><td><td>Количество шагов двигателя промотки бумаги (\a Count)
        <tr><td>35  <td><td><td><td><td><td><td>+<td><td><td><td>Количество циклов нагрева печатающей головки (\a Count)
        <tr><td>36  <td><td><td><td><td><td><td><td><td><td><td>Версия и сборка электронного модуля (\a VerHi, \a VerLo)
        <tr><td>38  <td><td><td><td><td><td><td><td><td>+<td><td>Состояние источника питания (\a PowerSupplyState)
        <br>Напряжение источника питания (\a PowerSupplyValue)
        <tr><td>39  <td><td><td><td><td><td><td><td><td><td><td>Исполнение (\a Value)
        <tr><td>40  <td>+<td><td><td><td><td><td><td><td><td><td>Необнуляемая сумма (\a Summ)
        <tr><td>41  <td>+<td><td><td><td><td><td><td><td><td>+<td>Сменный оборот налога по секциям (\a Value)
        Сумма налогов по секциям (\a Summ)
        <tr><td>42  <td>+<td><td><td><td><td><td><td><td><td><td>Сумма скидок за смену(\a DiscountInSession)
        Сумма надбавок за смену (\a ChargeInSession)
        <tr><td>43  <td><td><td><td><td><td><td><td><td><td><td>Код ошибки обмена ОФД:
        - Код ошибки сети (\a NetworkError)
        - Код ошибки ОФД (\a OFDError)
        - Код ошибки ФН (\a FNError)
        <tr><td>44  <td><td><td><td><td><td><td><td><td><td><td>Количество не отправленных документов в ФН (\a Count)
        <tr><td>45  <td><td><td><td><td><td><td><td><td><td><td>Дата и время самого раннего не отправленного документа в ФН (\a Date, \a Time)
        <tr><td><th>CheckType<th>TypeClose<th>OperationType<th>CounterDimension<th>TaxNumber<th>DiscountNumber<th>CounterType<th>StepCounterType<th>PowerSupplyType<th>Department<td>
       </table>
       \retval -1 Ошибка
       \retval 0 Успех
     */
    ...
    //! Возвращает флаг открытости смены.
    /*!
       \param value Флаг смены
       \retval 0 Успех
     */
    ...
    /*!
       \param value Флаг наличия бумаги
       \retval 0 Успех
     */
    ...
    /*!
       Метод печатает указанный отчет на ККМ.
       ...
       <table>
        ...
        <tr><td>TED::Fptr::ReportTestDevice                    <td>Тестирование ККМ<td><td>
        <tr><td>TED::Fptr::ReportPrintInfo                     <td>Печать информации о ККМ<td><td>
    ...
    /*!
       ...
       \param value Флаг буферизированной печати
       \retval 0 Успех
    ...
    //! Возвращает флаг очистки.
    /*!
       \param value Флаг очистки
       \retval 0 Успех
       \sa put_ClearFlag()
     */
    virtual int DTOSHARED_CCA get_ClearFlag(int *value) = 0;

    //! Устанавливает флаг очистки.
    /*!
       \param value Флаг очистки
       \retval -1 Ошибка
       \retval 0 Успех
    ...
    /*!
       Используется для настройки дисплея, подключенного через порт ККМ. Данное свойство нужно передать в TED::Display::IDisplay::put_ClsPtr().
    ...
    /*!
       Метод производит фискализацию или перерегистрацию ККМ с заданными параметрами.
       ...
       инспектора, входящее в комплект поставки ККМ.
       \retval -1 Ошибка
       \retval 0 Успех
     */
    ...
    /*!
       ...
       нельзя. После ввода заводского номера ККМ перестает быть демонстрационной версией и
       требует ввод лицензии (кода защиты) для выполнения лицензируемых функций

       Обычно ККМ продаются уже с введенным заводским номером, но существует
       демонстрационная (NFR) версия ККМ. Перед введением таких ККМ в эксплуатацию в них
       следует ввести заводской номер, указанный на табличке ККМ и в формуляре, входящем в ее
       комплект поставки.
    ...
    //! Производит общее гашение ККМ.
    /*!
       При выполнении метод производит общее гашение ККМ. Перед выполнением метода необходимо снять суточный отчет с гашением.
    ...
    /*!
       Метод производит технологическое обнуление ККМ. Технологическое обнуление включает в себя:
       ...
       определенном состоянии ККМ (подробнее смотрите в руководстве по сервисному
       обслуживанию для данной ККМ).
    ...
    //! Устанавливает настройку в ККМ.
    /*!
       Метод используется для записи данных в указанную ячейку любой системной таблицы ККМ.
       Структура таблиц описана в руководстве оператора и в протоколе работы ККМ, входящими в
       комплект поставки ККМ.
    ...
    //! Получает значение настройки из ККМ.
    /*!
       Метод используется для получения содержимого указанной ячейки из любой системной
       таблицы ККМ. Структура таблиц описана в руководстве оператора и в протоколе работы ККМ,
       входящими в комплект поставки ККМ.
    ...
    /*!
       Метод выполняет произвольную низкоуровневую команду протокола обмена ККМ.
    ...
    /*!
       \warning Выполняется только один раз при активизации текущей ЭКЛЗ в ККМ
       \retval -1 Ошибка
       \retval 0 Успех
     */
    ...
    /*!
       ...
       <table>
        ...
        <tr><td>TED::Fptr::ReportRom                <td>ПО ККМ<td><td>\a Caption
        <tr><td>TED::Fptr::ReportRomUnit            <td>ПО модуля ККМ<td>\a UnitType<td>\a Caption
    ...
    //! Устанавливает номер изображения в памяти ККМ.
    /*!
    ...
    //! Возвращает номер изображения в памяти ККМ.
    /*!
       \param value Номер изображения
       \retval 0 Успех
    ...
    //! Добавить изображение из файла в память ККМ.
    /*!
       <table>
        <caption>Свойства</caption>
        <tr><th>Название<th>Описание<th>Доступ
    ...
    //! Печатает изображение из памяти ККМ.
    /*!
       <table>
        <caption>Свойства</caption>
        <tr><th>Название<th>Описание<th>Доступ
    ...
    //! Запрашивает изображение из памяти ККМ.
    /*!
       <table>
        <caption>Свойства</caption>
        <tr><th>Название<th>Описание<th>Доступ
    ...
    //! Загружает изображение из буфера в память ККМ.
    /*!
       <table>
        <caption>Свойства</caption>
        <tr><th>Название<th>Описание<th>Доступ
    ...
    /*!
       Подробнее см. документацию на ККМ АТОЛ (команда 87h с режимКЛ=режимЧЛ=0)
...
При установке FontDblHeight в 0 (false) свойство ReceiptFontHeight выставляется в TED::Fptr::FontHeightSingle.
    ...
    //! Устанавливает позицию десятичной точки в ККМ.
    /*!
       <table>
        <caption>Свойства</caption>
        <tr><th>Название<th>Описание<th>Доступ
    ...
    /*!
       \param value Состояние батарейки
       \retval 0 Успех
     */
    ...
    //! Очищает массив штрихкодов в памяти ККМ.
    /*!
       Работает из режима программирования (TED::Fptr::ModeProgramming).
       \retval -1 Ошибка
       \retval 0 Успех
    ...
    //! Производит программное выключение ККМ.
    /*!
       \retval -1 Ошибка
       \retval 0 Успех
     */
    ...
    /*!
       Используется, когда устройство ввода соединено с портом ККМ.
    ...
    //! Возвращает дескриптор для управления портом ККМ из дУВ.
    /*!
       Используется для связи дУВ и дККМ в случае, когда устройство ввода соединено с портом ККМ.
       Полученный с помощью данного метода дескриптор необходимо передать в НАСТРОЕННЫЙ экземпляр дУВ.
       С помощью данного дескриптора дУВ будет активировать дККМ, если он не активирован,
    ...
    /*!
       Используется для связи дПС и дККМ в случае работы с пинпадом FPrintPay-01.
    ...
    /*!
       Используется для связи дПС и дККМ в случае работы с модемом FPrintPay-01.
    ...
    /*!
       <table>
        ...
        <tr><td>VerLo               <td>Подверсия ПО        <td>get_VerLo()
        <tr><td>Build               <td>Версия сборки ПО    <td>get_Build()
        <tr><td>Language            <td>Язык                <td>get_Language()
        <tr><td>DeviceDescription   <td>Описание устройства <td>get_DeviceDescription()
       </table>
       \retval -1 Ошибка
       \retval 0 Успех
    ...
    /*!
       \param value Флаг отсутствия бумаги
       \retval 0 Успех
     */
    ...
    /*!
       \param value Флаг отсутствия связи с принтером
       \retval 0 Успех
     */
    ...
    /*!
       \param value Флаг ошибки печатающего устройства
       \retval 0 Успех
     */
    ...
    /*!
       \param value Флаг ошибки отрезчика
       \retval 0 Успех
     */
    ...
    /*!
       \param value Флаг перегрева печатающей головки
       \retval 0 Успех
     */
    virtual int DTOSHARED_CCA get_PrinterOverheatError(int *value) = 0;

    //! Запрашивает краткое состояние ККМ.
    /*!
       <table>
        <caption>Свойства</caption>
        <tr><th>Название<th>Описание<th>Доступ
    ...
    //! Формирует штрихкод в памяти ККМ.
    /*!
       <table>
        <caption>Свойства</caption>
        <tr><th>Название<th>Описание<th>Доступ
