...
Последние версии драйвера идут с хорошим апи. Там нет nodejs биндинга, но есть web сервер, через который можно отдавать команды или написать под себя на go, он же в тренде =)
